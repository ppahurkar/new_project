...
class Brick(GameObject):
    COLORS = {1: '#FFB643', 2: '#ED639E', 3: '#00008b'}
...
class Game(tk.Frame):
    def __init__(self, master):
        ...
        self.width = 610
        self.height = 400
        self.bg_image = Image.open("/Users/parulpahurkar/Downloads/bg image.jpg")
        ...
        self.items = {}
        self.ball = None
        self.paddle = Paddle(self.canvas, self.width/2, 330)
    ...
    def draw_text(self, x, y, text , size = '45', color = "black"):
    ...
    def update_lives_text(self):
        ...
        if self.hud is None:
            self.hud = self.draw_text(50, 20, text, 15, color = 'black')
        else:
